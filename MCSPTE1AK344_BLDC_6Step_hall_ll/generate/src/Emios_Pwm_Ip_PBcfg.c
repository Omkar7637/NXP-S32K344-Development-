...
/* Emios PWM mode configuration structure for PwmEmios_0/EMIOS_PWM */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch1 =
{
    /* .ChannelId */            1U,
...
/* Emios PWM mode configuration structure for PwmEmios_0/EMIOS_TRIGGER_BCTU_MC_MEAS */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch3 =
{
    /* .ChannelId */            3U,
    /* .Mode */                 EMIOS_PWM_IP_MODE_OPWMB_FLAG,
    /* .Timebase */             EMIOS_PWM_IP_BUS_BCDE,
