...
/* Check if Lpspi_Ip.h file and Lpspi_Ip_Sa_PBcfg.c file are of the same Autosar version */
     ...
     (LPSPI_IP_AR_RELEASE_MINOR_VERSION != LPSPI_IP_SA_AR_RELEASE_MINOR_VERSION_PBCFG_C) || \
     (LPSPI_IP_AR_RELEASE_REVISION_VERSION != LPSPI_IP_SA_AR_RELEASE_REVISION_VERSION_PBCFG_C))
#error "AutoSar Version Numbers of Lpspi_Ip.h and Lpspi_Ip_Sa_PBcfg.c are different"
#endif
#if ((LPSPI_IP_SW_MAJOR_VERSION != LPSPI_IP_SA_SW_MAJOR_VERSION_PBCFG_C) || \
     (LPSPI_IP_SW_MINOR_VERSION != LPSPI_IP_SA_SW_MINOR_VERSION_PBCFG_C) || \
     (LPSPI_IP_SW_PATCH_VERSION != LPSPI_IP_SA_SW_PATCH_VERSION_PBCFG_C))
#error "Software Version Numbers of Lpspi_Ip.h and Lpspi_Ip_Sa_PBcfg.c are different"
#endif
...
static Lpspi_Ip_DeviceParamsType Lpspi_Ip_DeviceParamsCfg[1U] =
{
    {
        (uint8)8U, /* Frame size */
        (boolean)FALSE, /*Lsb */
...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_1 =
{
    1U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(1U) | LPSPI_CCR_PCSSCK(1U) | LPSPI_CCR_SCKDIV(198U) | LPSPI_CCR_DBT(2U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(0U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(1U) | LPSPI_TCR_PCS(0U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_1 =
{
    1U,  /* Instance */
     /* CR */
    (uint32)0,
