...
#define TRGMUX_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define TRGMUX_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define TRGMUX_IP_BOARD_InitPeripherals_PBCFG_SW_MAJOR_VERSION_C              3
...
#if (TRGMUX_IP_BOARD_InitPeripherals_PBCFG_VENDOR_ID_C != TRGMUX_IP_CFG_VENDOR_ID)
...
#if ((TRGMUX_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_MAJOR_VERSION_C != TRGMUX_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (TRGMUX_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_MINOR_VERSION_C != TRGMUX_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (TRGMUX_IP_BOARD_InitPeripherals_PBCFG_AR_RELEASE_REVISION_VERSION_C != TRGMUX_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((TRGMUX_IP_BOARD_InitPeripherals_PBCFG_SW_MAJOR_VERSION_C != TRGMUX_IP_CFG_SW_MAJOR_VERSION) || \
     (TRGMUX_IP_BOARD_InitPeripherals_PBCFG_SW_MINOR_VERSION_C != TRGMUX_IP_CFG_SW_MINOR_VERSION) || \
     (TRGMUX_IP_BOARD_InitPeripherals_PBCFG_SW_PATCH_VERSION_C != TRGMUX_IP_CFG_SW_PATCH_VERSION) \
    )
...
const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger0ConfigPB =
{
    ...
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_SIUL2_12_15_OUT12,
    /* uint8 Input; */          TRGMUX_IP_INPUT_EMIOS0_IPP_CH1,
...
const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger1ConfigPB =
{
    ...
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_SIUL2_8_11_OUT9,
    /* uint8 Input; */          TRGMUX_IP_INPUT_EMIOS0_IPP_CH3,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};
...
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_2_TRIGGER_0,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_LCU0_0_INP_I0,
    /* uint8 Input; */          TRGMUX_IP_INPUT_EMIOS0_IPP_CH1,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};
...
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_2_TRIGGER_1,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_LCU0_0_INP_I1,
    /* uint8 Input; */          TRGMUX_IP_INPUT_SIUL2_IN13,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};

const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger4ConfigPB =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_2_TRIGGER_2,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_LCU0_0_INP_I2,
    /* uint8 Input; */          TRGMUX_IP_INPUT_SIUL2_IN14,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};

const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger5ConfigPB =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_2_TRIGGER_3,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_LCU0_0_INP_I3,
    /* uint8 Input; */          TRGMUX_IP_INPUT_SIUL2_IN15,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};

const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger6ConfigPB =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_3_TRIGGER_0,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_EMIOS1_CH1_4_IPP_IND_CH1,
    /* uint8 Input; */          TRGMUX_IP_INPUT_LCU0_LC2_OUT_I3,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};
