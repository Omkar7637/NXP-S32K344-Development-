...
*                                      DEFINES AND MACROS
==================================================================================================*/
#define ADCHWUNIT_0_INSTANCE    (0U)
#define ADCHWUNIT_2_INSTANCE    (2U)
...
/**
* @brief          ADC SAR Ip Config for Hardware Unit ADC2 for configuration variant .
*/
extern const Adc_Sar_Ip_ConfigType AdcHwUnit_2;
