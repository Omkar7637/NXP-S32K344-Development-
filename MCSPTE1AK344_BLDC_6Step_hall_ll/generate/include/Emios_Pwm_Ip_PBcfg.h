...
*                                            CONSTANTS
==================================================================================================*/
/* Emios instance index for configuration PwmEmios_0/EMIOS_PWM */
#define EMIOS_PWM_IP_I0_CH1_CFG      (0U)

/* Macro to enable the mode operations. */
#ifndef EMIOS_PWM_IP_MODE_OPWMB_USED
#define EMIOS_PWM_IP_MODE_OPWMB_USED
#endif
/* Emios instance index for configuration PwmEmios_0/EMIOS_TRIGGER_BCTU_MC_MEAS */
#define EMIOS_PWM_IP_I0_CH3_CFG      (0U)
...
extern const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch1;

/* Emios channel 3 configuration */
extern const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I0_Ch3;
