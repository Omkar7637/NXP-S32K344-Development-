...
#define SIUL2_ICU_IP_SW_MAJOR_VERSION_C            3
...
#if (STD_ON == SIUL2_ICU_IP_ENABLE_USER_MODE_SUPPORT)
    #if (defined (MCAL_SIUL2_AE_REG_PROT_AVAILABLE))
...
void Siul2_Icu_SetUserAccessAllowed(uint32 siul2BaseAddr)
{
#if defined(SIUL2_ICU_AE_REG_PROT_AVAILABLE)
...
#endif /* SIUL2_ICU_AE_REG_PROT_AVAILABLE */
}
